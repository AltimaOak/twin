    ...
    <div className="min-h-screen bg-[#faf8f5] text-stone-900 font-sans flex items-center justify-center p-4 sm:p-8">
      <div className="max-w-4xl w-full mx-auto">
        ...
        <div className="bg-white border border-stone-200/90 rounded-3xl sm:rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.06)] overflow-hidden grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="bg-white p-6 sm:p-10 flex flex-col justify-center space-y-4">
            <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-3.5 py-2 rounded-xl border border-stone-200/90 text-stone-900 text-xs sm:text-sm focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors"
                  />
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 pt-1">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 rounded text-[#f9570c] accent-[#f9570c] focus:ring-orange-500 border-stone-300"
                />
                <label htmlFor="signup-agreeTerms" className="text-xs text-stone-600 select-none cursor-pointer">
                  I agree to the{' '}
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2 px-4 rounded-xl border border-stone-200/90 bg-white text-stone-700 text-xs font-semibold hover:bg-stone-50 transition-colors shadow-xs cursor-pointer"
              >
